<?php
/**
 * bluebead functions and definitions
 *
 * @package bluebead
 */
...
function bluebead_setup() {
	 ...
	 * If you're building a theme based on bluebead, use a find and replace
	 * to change 'bluebead' to the name of your theme in all the template files
	 */
